...
export const stories: Story[] = [
  {
    ...
    proveIt: { question: 'Why could Lumi and the beetle find their way home?', options: ['They combined their little lights', 'The sun came out', 'A bird carried them'], correct: 0, explanation: 'Two little sparks together made the path bright enough to follow.' },
  ...
  },
  {
    ...
    proveIt: { question: 'What shows that Mila was persistent?', options: ['She tried the patch again after it failed', 'She waited for someone else', 'She bought a new kite'], correct: 0, explanation: 'Mila kept trying even when her first two patches did not work.' },
  ...
  },
  {
    ...
    proveIt: { question: 'How did Nova and Orion finally solve their disagreement?', options: ['They combined parts of both plans', 'Nova worked alone', 'They left the crystal behind'], correct: 0, explanation: 'Their compromise used Orion’s safe case and Nova’s steady hands.' },
