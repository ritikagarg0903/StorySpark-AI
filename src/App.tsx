...
function App() {
  ...
  const displayName = name.trim() || 'Reader'
  ...
  async function generateNextStory() {
    ...
    setStoryError('')
    const tiers: Story['tier'][] = ['Grade 4-5', 'Grade 6-7', 'Grade 8']
...
function Adapt({next,generating,generated,error,onNext,onRecap}:{next:Story;generating:boolean;generated:boolean;error:string;onNext:()=>void;onRecap:()=>void}) {
  return <section className="center-stage adapt-stage">
    ...
    <div className="button-row simple"><button className="secondary" onClick={onRecap}>View reading recap</button></div>
  </section>
}
